...
def print_operation_table(operation, num_rows=1, num_columns=1):
    num_columns = int(input("Please,enter your num_colums: "))
    num_rows = int(input("Please,enter your num_rows: "))
